//
//  JJSingleChooseViewController.m
//  FunStudy
//
...
@interface JJSingleChooseViewController ()
...
//模型数组
@property (nonatomic, strong) NSMutableArray<JJSingleChooseModel *> *modelArray;
...
@implementation JJSingleChooseViewController
...
//
//    
//    JJSingleChooseModel *model1 = [[JJSingleChooseModel alloc]init];
//    model1.question = @"-what is your jop\n-I am_________?";
//    JJSingleChooseOptionalModel *op1model1 = [[JJSingleChooseOptionalModel alloc]init];
//    op1model1.letter = @"A";op1model1.word = @"apple";
...
//    model1.optionModelList = @[op1model1,op1model2,op1model3,op1model4];
//    JJSingleChooseView *singleChooseView1 = [JJSingleChooseView singleChooseViewWithType:SingleChooseText singleChooseModel:model1 trueChoose:@"A"];
//    
//    
//    JJSingleChooseModel *model2 = [[JJSingleChooseModel alloc]init];
//    model2.question = @"http://m2.quanjing.com/2m/alamyrf005/b1fw89.jpg";
//    JJSingleChooseOptionalModel *op2model1 = [[JJSingleChooseOptionalModel alloc]init];
//    op2model1.letter = @"A";op2model1.word = @"apple";
//    JJSingleChooseOptionalModel *op2model2 = [[JJSingleChooseOptionalModel alloc]init];
//    op2model2.letter = @"B";op2model2.word = @"apple1";
//    JJSingleChooseOptionalModel *op2model3 = [[JJSingleChooseOptionalModel alloc]init];
//    op2model3.letter = @"C";op2model3.word = @"apple2";
//    JJSingleChooseOptionalModel *op2model4 = [[JJSingleChooseOptionalModel alloc]init];
//    op2model4.letter = @"D";op2model4.word = @"apple3";
//    model2.optionModelList = @[op2model1,op2model2,op2model3,op2model4];
//    JJSingleChooseView *singleChooseView2 = [JJSingleChooseView singleChooseViewWithType:SingleChooseImageView singleChooseModel:model2 trueChoose:@"A"];
//
//    singleChooseView1.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
//    [self.scrollView addSubview:singleChooseView1];
//    singleChooseView2.frame = CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
//    [self.scrollView addSubview:singleChooseView2];
    ...
    [HFNetWork postWithURL:URL params:params isCache:NO success:^(id response) {
       ...
       self.homeworkID = self.topicModel.homework_id;
        ...
        for(NSDictionary *dict in dataArray) {
            JJSingleChooseModel *singleChooseModelModel = [JJSingleChooseModel modelWithDictionary:dict];
            singleChooseModelModel.topic_title = self.topicModel.topic_title;
            JJSingleChooseView *singleChooseView = [JJSingleChooseView singleChooseViewWithSingleChooseModel:singleChooseModelModel ];
            singleChooseView.frame = CGRectMake(self.modelArray.count * SCREEN_WIDTH, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
            [self.scrollView addSubview:singleChooseView];
            [self.modelArray addObject:singleChooseModelModel];
...
- (void)requestToSubmitHomework {
    ...
    for(int i = 0; i < self.modelArray.count; i++) {
        JJSingleChooseModel *model = self.modelArray[i];
        if(i == 0) {
