...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        CGPoint arcCenter = CGPointMake(self.radius+self.strokeThickness/2+(5 * KWIDTH_IPHONE6_SCALE), self.radius+self.strokeThickness/2+(5 * KWIDTH_IPHONE6_SCALE));
...
- (CGSize)sizeThatFits:(CGSize)size {
    return CGSizeMake((self.radius+self.strokeThickness/2+(5 *KWIDTH_IPHONE6_SCALE))*2, (self.radius+self.strokeThickness/2+(5 * KWIDTH_IPHONE6_SCALE))*2);
}
