...
typedef void (^TC_VP_SelectedBlock)(id viewPager, NSInteger index);
...
@property (nonatomic, strong) UIScrollView *pageControl;
 ...
 *  @param titlePageW  头部pageController中每个Button的宽度
 *  @param selectedLabelScale  被选中时的红色label与按钮的比例
 *
 *  @return YFViewPager
 */
