//
//  JJIsSelfStudyTopicViewController.m
//  FunStudy
//
...
@interface JJIsSelfStudyTopicViewController ()
...
@implementation JJIsSelfStudyTopicViewController
...
#pragma mark - 基本设置
- (void)setUpBaseView{
    self.titleName = self.model.unit_title;
    //背景图片
...
- (void)requestWithTopicList {
    ...
    NSString *URL =[NSString stringWithFormat:@"%@%@", DEVELOP_BASE_URL, API_STUDY_HOMEWORK_LIST];
    NSDictionary *params = nil;
    params = @{@"fun_user_id" : [User getUserInformation].fun_user_id , @"unit_id" : self.model.unit_id, @"book_id" : self.model.book_id};
    ...
    [HFNetWork postWithURL:URL params:params isCache:NO success:^(id response) {
        ...
        self.topicModelArray = [JJTopicModel mj_objectArrayWithKeyValuesArray:response[@"data"][@"topic_list"]];
        for(JJTopicModel *model in self.topicModelArray) {
            model.homework_id = response[@"data"][@"homework_id"];
            model.isSelfStudy = YES;
        }
...
- (void)requestWithTopicListPrimarySchool {
    ...
    [HFNetWork postWithURL:URL params:params isCache:NO success:^(id response) {
        ...
        for(JJPlateModel *plateModel in plateModelArray) {
            ...
            if([plateModel.plate_name isEqualToString:self.model.unit_title]) {
    ...
    [HFNetWork postWithURL:URL params:params isCache:NO success:^(id response) {
        ...
        for(NSInteger i = 0; i<self.topicModelArray.count; i++) {
            ...
            if(i == (self.topicModelArray.count - 1)) {
                ...
                ov.name = @"最新作业";
                ov.isSelfStudy = YES;
                ov.homework_id = response[@"data"][@"homework_id"];
...
- (void)observeToRefreshTableViewRequestPrimary {
    ...
    [HFNetWork postWithURL:URL params:params isCache:NO success:^(id response) {
        ...
        NSArray<JJTopicModel *> *allTopicModelArray = [JJTopicModel mj_objectArrayWithKeyValuesArray:response[@"data"][@"topic_list"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    bookCell.shadowView.hidden = YES;
    bookCell.userInteractionEnabled = YES;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (model.type) {
        case ListenType://听力
        {
            ...
            listeningTestViewController.name = @"最新作业";
        ...
        case ClozeProcedureType://完型填空
        {
            ...
            clozeProcedureViewController.name = @"最新作业";
        ...
        case ReadType://阅读理解
        {
            ...
            readTestViewController.name = @"最新作业";
        ...
        case TranslateType://翻译
        {
            ...
            transLateViewController.name = @"最新作业";
        ...
        case ErrorCorrectType://改错
        {
            ...
            errorCorrectionViewController.name = @"最新作业";
        ...
        case WriteType://作文
        {
            ...
            writeTestViewController.name = @"最新作业";
        ...
        case FollowReadType://跟读
        {
            ...
            followReadViewController.name = @"最新作业";
        ...
        case ReadWordType://朗读
        {
            ...
            readAloudViewController.name = @"最新作业";
        ...
        case BilingualType://中英对照
        {
            ...
            bilingualViewController.name = @"最新作业";
